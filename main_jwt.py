...
def delete_fakultas(
    ...
    if r.status_code != 204:
        ...
        raise HTTPException(
            status_code=r.status_code,
            detail="Gagal menghapus fakultas"
        )
...
@appjwt.post("/jurusan")
def tambah_jurusan(jurusan: Jurusan, token=Depends(verify_token)):
...
def delete_jurusan(
    ...
    if r.status_code != 204:
        ...
        raise HTTPException(
            status_code=r.status_code,
            detail="Gagal menghapus Program Studi"
        )
